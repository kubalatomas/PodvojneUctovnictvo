 ...
 * @author Tomáš
 */
public class PPD extends UctovnyDoklad {
    private static int posledneId = 1;
    private String interneCislo = "PPD-";

    public PPD(String znenieDokladu, Calendar datumDokladu, double sumaDokladu, Partner partner, List<Predkontacia> predkontacieDokladu) {
